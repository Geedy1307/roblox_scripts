...
pcall(function()
	...
	if not isfile("saswareblockspindiscordprompted.txt") then
		local UI, Button1, Button2 = InteractiveToast(
			"Important Notice",
			"Unfortunately, Sasware BlockSpin is going paid, and the free version is outdated and will stop working soon. Please join the discord for more information. This is the only time you will see this message. \nhttps://discord.gg/6qCymXqa2u",
			"Exit",
			"Acknowledge"
		)

		UI.DisplayOrder = 5000
		...
		Button2.Activated:Once(function()
			UI:Destroy()
		end)

		writefile("saswareblockspindiscordprompted.txt", "true")
		...
		DiscordInviter.Join("https://discord.gg/6qCymXqa2u")
	end
end)
